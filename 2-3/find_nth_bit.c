...
int main()
{
    // 0x80000800010, 1 bits at 4, 23, 43
    // 0x400004000020000, 1 bits at 17(81),38(102),58(122)
    // 0x4000000, 1 bits at 26(154)
    unsigned long test[3] = {0x80000800010, 0x400004000020000, 0x4000000};
    unsigned long ret = 0;
    ret = find_nth_bit(test, 180, 6);
    printf("%ld\n", ret);
    return 0;
}